<template>
    <div @blur="toggleShowOptions" class="flex">
        <input
            type="text"
            :name="info"
            id="info"
            ...
            class="bg-red-200 w-full border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow focus:outline-none focus:shadow-outline"
        />
