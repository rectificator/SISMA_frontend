<template>
    <header class="shadow w-full">
        <nav>
            <nav
                class="flex items-center justify-between flex-wrap bg-white p-6 bg-red-200"
            >
                <div
                    class="flex flex-wrap items-center text-black mr-6 bg-green-200 flex-grow-0 w-1/6"
                >
