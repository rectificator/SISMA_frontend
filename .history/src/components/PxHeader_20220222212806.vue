<template>
    <header class="shadow w-full">
        <nav>
            <nav
                class="flex items-center justify-between flex-wrap bg-white p-2"
            >
                <div class="flex items-center text-black mr-6">
                    ...
                    <router-link
                        class="ml-4 font-semibold text-xl tracking-tight"
                        :to="{ name: 'home' }"
                    >
                        SISMA
                    </router-link>
                ...
                <div
                    class="sm:block w-full block flex-grow lg:flex lg:items-center lg:wauto"
                >
