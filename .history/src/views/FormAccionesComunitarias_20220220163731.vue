...
export default {
    ...
    methods: {
        ...
        validateForm() {
            this.errors['objetivo_actividad'] =
                'objetivo_actividad' in this.info
            this.errors['no_personas_alcanzadas'] =
                'no_personas_alcanzadas' in this.info
            this.errors['no_actividades_realizadas'] =
                'no_actividades_realizadas' in this.info
            this.errors['tipo_actividad'] = 'tipo_actividad' in this.info
        },
    },
}
</script>
