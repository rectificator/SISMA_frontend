    ...
    <div class="py-4 px-4">
            ...
            >
                ...
                <div class="absolute choroplethInnerInfo-lg">
                    <span
                        ...
                        >{{
                            randomizeTotal(totalNacionalAccionesComunitarias)
                        }}</span
                    >
                    ...
                    <span
                        class="block text-center text-2xl pt-6 font-bold text-red-800"
                        >{{
                            randomizeTotal(totalNacionalAccionesPrevencionSalud)
                        }}</span
                    >
                    <p class="block text-lg font-bold text-center">
                        PERSONAS ALCANZADAS EN
                    ...
                    <span
                        ...
                        >{{ randomizeTotal(totalAccionesNacionales) }}
                    </span>
            ...
            <div class="flex justify-around w-full">
                ...
                <div class="w-1/3 h-96 choroplethInnerInfo">
                    ...
                    <span
                        ...
                        >{{
                            randomizetotal(
                                totalNacionalActividadesAccionesComunitTrias
                            )
                        }}
                    </span>
                    <p
            ...
            >
                ...
                <div class="absolute choroplethInnerInfo-lg">
                    ...
                    <span
                        class="block text-center text-2xl pt-2 font-bold text-red-800"
                        >{{
                            randomizeTotal(totalpersonasCapacitadasSaludMental)
                        }}
                    </span>
                    <p class="block text-lg font-bold text-center text-red-800">
            ...
            <div class="flex justify-around w-full">
                ...
                <div class="w-1/3 h-96 choroplethInnerInfo">
                    ...
                    <span
                        ...
                        >{{
                            randomizetotal(
                                totalNacionalCapacitacionesRealizadasSaludMTntal
                            )
                        }}
                    </span>
                    <p
            ...
            >
                ...
                <div class="absolute choroplethInnerInfo">
                    <span
                        class="block text-center text-2xl pt-6 font-bold text-red-800"
                        >{{
                            randomizeTotal(totalPersonal1erNivelCapacitado)
                        }}</span
                    >
                    <p class="block text-lg font-bold text-center">
            ...
            >
                ...
                <div class="absolute choroplethInnerInfo">
                    <span
                        ...
                        >{{
                            randomizetotal(
                                totalNacionalPersonasQueCursaronDiplomadoSuiTidio
                            )
                        }}
                    </span>
                    <p class="block text-lg font-bold text-center">
        ...
        <section id="consultas" class="flex flex-col pt-24 items-center">
            ...
            >
                ...
                <span>{{ randomizeTotal(totalNoConsultasPrimeraVez) }}</span>
            </p>
            <p
            ...
            >
                ...
                <span>{{ randomizeTotal(totalNoConsultasSubsecuentes) }}</span>
            </p>
        </section>
        ...
        <section id="resumen" class="flex flex-col pt-24 items-center">
            <div class="flex justify-around w-4/5">
                ...
                >
                    <div class="h-32"></div>
                    <span>{{ randomizeTotal(totalReunionesDeTrabajo) }}</span>
                ...
                >
                    <div class="h-32"></div>
                    <span>{{
                        randomizeTotal(totalConveniosDeColaboracion)
                    }}</span>
                ...
                >
                    <div class="h-32"></div>
                    <span>{{ randomizeTotal(totalBeneficiosOtorgados) }}</span>
                ...
                >
                    <div class="h-32"></div>
                    <span>{{ randomizeTotal(totalPoliticasPublicas) }}</span>
