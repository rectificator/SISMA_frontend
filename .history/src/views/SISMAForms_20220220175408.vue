<template>
    <div>
        ...
        >
            <px-select-anio :error="error.anio" @select-value="getAnio"></px-select-anio>
            <px-select-mes :error="error.mes" @select-value="getMes"></px-select-mes>
            <px-auto-complete-estado :error="error.estado" @select-value="getEstado" />
            <px-auto-complete-municipio :error="error.municipio" @select-value="getMunicipio" />
            <px-auto-complete-institucion :error="error.institucion" @select-value="getInstitucion" />
