...
export default {
    ...
    created() {
        ...
        api.getFrom('sisma/, jwtestado').then((data) => {
        ...
        api.getFrom('sisma/, jwtmunicipio').then((data) => {
            //console.log('DATA: ', data)
            this.municipalities = data
        })
        api.getFrom('acciones_prevencion_salud', jwt).then((data) => {
            //console.log('DATA: ', data)
            this.acciones_prevencion_salud = data
        })
        api.getFrom('acciones_comunitarias', jwt).then((data) => {
            //console.log('DATA: ', data)
            this.acciones_comunitarias = data
        })
        api.getFrom('atencion_salud', jwt).then((data) => {
            //console.log('DATA: ', data)
            this.atencion_salud = data
        })
        api.getFrom('capacitacion', jwt).then((data) => {
            //console.log('DATA: ', data)
            this.capacitacion = data
        })
        api.getFrom('politicas_publicas', jwt).then((data) => {
            //console.log('DATA: ', data)
            this.politicas_publicas = data
        })
        api.getFrom('suicidio', jwt).then((data) => {
            //console.log('DATA: ', data)
            this.suicidio = data
        })
    },
