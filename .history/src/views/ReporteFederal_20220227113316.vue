    ...
    <div class="py-4">
        ...
        >
            ...
            <div class="flex justify-around w-full">
                <table class="mt-2flex-grow-0">
                    <tr class="">
                        <th class="text-sm border px-1 bg-red-300">Estados</th>
                        <th class="text-sm border px-1 bg-red-300">
                ...
                <table class="mt-2flex-grow-0">
                    <tr class="">
                        <th class="text-sm border px-1">Estados</th>
                        <th class="text-sm border px-1">
                            Número de actividades
                        </th>
                    </tr>
                    <tr>
