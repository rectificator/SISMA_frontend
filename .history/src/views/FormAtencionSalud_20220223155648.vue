...
export default {
    ...
    methods: {
        ...
        addToError() {
            ...
            for (let questionIndex = 0; questionIndex < this.decimalNumberQuestionLabels.length; questionIndex++) {
                this.addFieldToError(this.decimalNumberQuestionLabels[questionIndex])
            }
        },
