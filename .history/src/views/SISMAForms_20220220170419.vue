...
export default {
    ...
    methods: {
        ...
        getAccionesComunitarias(acciones_comunitarias) {
            ...
            this.info[this.formName].tipo_actividad =
                acciones_comunitarias.tipo_actividad */
            this.moveFieldInfoFromObjectToThisInfoObject(
        ...
        moveFieldInfoFromObjectToThisInfoObject(object, field) {
