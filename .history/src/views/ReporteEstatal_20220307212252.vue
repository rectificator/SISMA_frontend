<template>
    <div class="py-4 px-4">
        ...
        <section id="" class="flex flex-col pt-24 items-center">
            <div class="w-2/3 h-30">
                <polar-area-chart :chart-data="capacitacionesPorMes" />
            </div>
        </section>
        ...
        <section id="" class="flex flex-col pt-24 items-center">
            ...
            <div class="w-2/3 h-30">
                <pie-chart :chart-data="capacitacionesPorMes" />
            </div>
        </section>
...
export default {
    ...
    computed: {
        ...
        capacitacionesPorMes() {
            return this.randomDoughnutDataCollection('Capacitaciones por mes')
        },
