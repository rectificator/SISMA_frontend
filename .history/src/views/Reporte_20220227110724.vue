<template>
    <div>
        ...
        <reporte-estatal v-if="reportSelect == false" class="z-0 pt-20" />
        <reporte-federal v-if="reportSelect == true" class="z-0 pt-20" />
    </div>
</template>
