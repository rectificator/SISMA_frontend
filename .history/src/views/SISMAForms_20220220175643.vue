<template>
    <div>
        ...
        >
            <px-select-anio
                :error="'anio' in errors.anio"
                @select-value="getAnio"
            ></px-select-anio>
            <px-select-mes
                :error="'mes' in errors.mes"
                @select-value="getMes"
            ></px-select-mes>
            <px-auto-complete-estado
                :error="'estado' in errors.estado"
                @select-value="getEstado"
            />
            <px-auto-complete-municipio
                :error="'municipio' in errors.municipio"
                @select-value="getMunicipio"
            />
            <px-auto-complete-institucion
                :error="'institucion' in errors.institucion"
