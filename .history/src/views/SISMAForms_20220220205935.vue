<template>
    <div>
        ...
        >
            <px-select-anio
                :error="errorField == 'anio'"
                @select-value="getAnio"
            ></px-select-anio>
            <px-select-mes
                :error="errorField == 'mes'"
                @select-value="getMes"
            ></px-select-mes>
            ...
            if (
                ...
                for (
                    ...
                    if (this.errors[key] == false) {
                        this.$set(this.$data, 'errorKeys', key)
                        this.validate = false
                        break
                    }
                }
