...
export default {
    ...
    props: {
        ...
        acrividadesRealizadasAccionesPrevencionSalud: {
            type: Array,
            default: () => new Array(32).fill(0),
        },
    ...
    computed: {
        ...
        actividadesRealizadasPorEstadoAccionesPrevencionSalud() {
            return this.acrividadesRealizadasAccionesPrevencionSalud.map(
                (no_actividades, index) => {
                    return { estado: this.states[index], no_actividades }
                }
            )
        },
