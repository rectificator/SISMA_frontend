        ...
        <div class="absolute px-16 py-8 w-full h-full">
            <div class="w-full h-full p-12 bg-gray-100 rounded-md">
                ...
                <form class="mt-6 px-48">
                    ...
                    <button
                        type="submit"
                        class="w-full py-3 mt-6 font-medium text-lg rounded-full tracking-widest text-white bg-blue-300 shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none"
                    >
                        Ingresar
                    </button>
                </form>
