        ...
        <div class="relative block">
            ...
            >
                ...
                <px-auto-complete-municipio
                    ...
                    :id_estado="info.info_registro.id_estado"
            ...
            /> -->
                ...
                <form-politicas-publicas
                    v-if="formRoute == availableForms.politicas_publicas"
                    @change="getComplementaryFormData"
                />
                ...
                <form-mh-gap
                    v-if="formRoute == availableForms.mhGAP"
                    @change="getComplementaryFormData"
                />
...
import FormPoliticasPublicas from '@/views/FormPoliticasPublicas'
import FormSuicidio from '@/views/FormSuicidio'
import FormMhGap from '@/views/FormMhGap'
...
export default {
    ...
    methods: {
        ...
        getEstado(value) {
            ...
            this.$set(this.info.info_registro, 'id_estado', value.id)
        },
