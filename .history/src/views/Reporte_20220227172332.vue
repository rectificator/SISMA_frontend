...
export default {
    ...
    computed: {
        capacitacionSaludMentalEstatalDataSet() {
            ...
            let typeOfCapAux = typeof capacitacionAux
            console.log(typeOfCapAux)
            if (typeOfCapAux != undefined && typeOfCapAux.length > 0) {
                let ignoreTagList = [
                ...
                console.log('CapacitacionAUX: ', capacitacionAux[0])
                let capKeys = Object.keys(capacitacionAux[0])
                console.log('CapacitacionAUX: ', capKeys)
                for (let key of capKeys) {
                    console.log('VAL: ', capacitacionAux[0][key])
                }
            }
