    ...
    <div class="py-4 px-4">
        ...
        >
            ...
            <div class="flex justify-around w-full">
                ...
                <div class="w-1/3 h-96 choroplethInnerInfo">
                    ...
                    <span
                        class="block text-center text-2xl pt-2 font-bold text-red-800"
                        >{{ totalActividadesAccionesComunitarias }}
                    </span>
                    <p
                ...
                <div class="flex flex-grow-0">
                    ...
                    <table class="inline-block mt-2">
                        ...
                        <tr v-for="(state, index) in states" :key="index">
                            <th
                                v-if="index >= 16"
                                class="w-20 text-base border px-2"
                            >
                                {{ state.estado }}
                            </th>
                            <th
                                v-if="index >= 16"
                                class="w-21 text-base border px-2"
                            >
                                348
                            </th>
                        </tr>
        ...
        >
            ...
            >
                ...
                <div class="absolute choroplethInnerInfo-lg">
                    ...
                    >
                    <p class="block text-lg font-bold text-center">
                        PERSONAS ALCANZADAS POR ESTADO
                    </p>
                    <span
                        class="block text-center text-2xl pt-6 font-bold text-red-800"
                        >1,118,204
                    ...
                    <p class="block text-lg font-bold text-center">
                        PERSONAS ALCANZADAAS EN ACCIONES A NIVEL NACIONAL
                    </p>
                    <span
                        class="block text-center text-2xl mt-4 pt-2 font-bold text-red-800 border-t-red-600"
                        >TOTAL
        ...
        <section id="consultas" class="flex flex-col pt-24 items-center">
            ...
            <p
                class="block pt-4 py-2 mt-2 text-xl font-semibold text-gray-900 bg-transparent rounded-lg"
            >
                DISTRIBUCIÓN POR DIAGNÓSTICO CAPAS
            </p>
...
export default {
    ...
    computed: {
        totalNacionalAccionesComunitarias() {
            return this.personasAlcanzadasAccionesComunitarias.reduce(
                (a, b) => a + b
            )
        },
        totalNacionalAccionesPrevencionSalud() {
            return this.personasAlcanzadasAccionesPrevencionSalud.reduce(
                (a, b) => a + b
            )
        },
        accionesNacionales() {
            ...
            for (
                let index = 0;
                index < this.personasAlcanzadasAtencionSalud.length;
                index++
            ) {
                aux[index] =
                    this.personasAlcanzadasAtencionSalud[index] +
                    this.personasAlcanzadasAccionesComunitarias[index]
            }
        ...
        actividadesRealizadasPorEstadoAccionesPrevencionSalud() {
            return this.actividadesRealizadasAccionesPrevencionSalud.map(
                (no_actividades, index) => {
                    return { estado: this.states[index].estado, no_actividades }
                }
            )
        },
        actividadesRealizadasPorEstadoAccionesComunitarias() {
            return this.acrividadesRealizadasAccionesComunitarias.map(
                (no_actividades, index) => {
                    return { estado: this.states[index].estado, no_actividades }
                }
            )
        ...
        totalNacionalActividadesAccionesPrevencionSalud() {
            return this.actividadesRealizadasAccionesPrevencionSalud.reduce(
                (a, b) => a + b
            )
        },
        totalNacionalActividadesAccionesComunitarias() {
            return this.acrividadesRealizadasAccionesComunitarias.reduce(
                (a, b) => a + b
            )
        },
    },
