<template>
    <div>
        ...
        <reporte-estatal v-if="reportSelect == false" class="z-0 mt-4" />
        <reporte-federal v-if="reportSelect == true" class="z-0 mt-4" />
    </div>
</template>
