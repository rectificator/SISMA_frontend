...
export default {
    ...
    methods: {
        ...
        validateForm() {
            errors['objetivo_actividad'] = 'objetivo_actividad' in this.info
            errors['no_personas_alcanzadas'] =
                'no_personas_alcanzadas' in this.info
            errors['no_actividades_realizadas'] =
                'no_actividades_realizadas' in this.info
            errors['tipo_actividad'] = 'tipo_actividad' in this.info
        },
    },
}
</script>
