<template>
    <div class="relative px-6 -mt-6">
        <div class="fixed block pt-2 px-2 -mt-12 bg-red-100">
            <px-header :links="links" />
            <div
                class="w-full shadow bg-loginSisma text-white font-bold text-lg py-2 px-4 mt-2"
            >
                <p>{{ formName }}</p>
            </div>
        </div>
        <form
            ...
            class="mt-6 flex flex-col space-y-6 px-4 mt-24"
        >
            <px-select-anio
