...
export default {
    ...
    methods: {
        ...
        validateForm() {
            this.errors['objetivo_actividad'] = 'id_anio' in this.info
            this.errors['no_personas_alcanzadas'] = 'id_anio' in this.info
            this.errors['no_actividades_realizadas'] = 'id_anio' in this.info
            this.errors['tipo_actividad'] = 'id_anio' in this.info
        },
    },
}
</script>
