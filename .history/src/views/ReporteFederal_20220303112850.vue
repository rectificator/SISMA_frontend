        ...
        >
            ...
            >
                ...
                <div class="absolute choroplethInnerInfo-lg">
                    <p class="block mt-12 text-lg font-bold text-center">
            ...
            <div class="flex justify-around w-full">
                <div class="flex flex-grow-0">
                    <table class="inline-block mt-2 mr-6">
                        <tr class="">
                            <th class="w-28 text-base border px-1 bg-red-300">
                                Estados
                            </th>
                            <th class="w-16 text-base border px-1 bg-red-300">
                        ...
                        <tr v-for="(state, index) in states" :key="index">
                            <th
                                v-if="index < 16"
                                class="w-28 text-base border px-2"
                            >
                                {{ state.estado }}
                            </th>
                            <th
                                v-if="index < 16"
                                class="w-16 text-base border px-2"
                            >
                                235
                            </th>
                        </tr>
