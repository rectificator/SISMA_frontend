<template>
    <div>
        ...
        >
            ...
            <div v-if="formRequiereModalidadAndPoblacionFields">
                <px-select-poblacion @select-value="getPoblacion" />
                <px-select-modalidad @select-value="getModalidad" />
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            formRequiereModalidadAndPoblacionFields:
                formsThatRequireModalidadAndPoblacionFields.includes(
                    this.formName
                ),
        }
    },
