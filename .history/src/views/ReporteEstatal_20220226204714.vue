    ...
    <div class="py-4">
        ...
        >
            ...
            >
                ...
                <div class="absolute bg-red-400 choroplethInnerInfo">
                    <span
                        class="block text-center text-lg pt-6 font-bold text-red-800"
                        >45,497</span
                    >
                    <p class="block text-base font-bold text-center">
        ...
        <section id="suicidio" class="flex flex-col pt-24 items-center">
            ...
            <div
                class="overflow-hidden rounded-md border border-gray-400 w-11/12 choroplethContainer"
            >
                <div class="choropleth">
                    <state-choropleth />
                </div>
