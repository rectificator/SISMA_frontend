    ...
    methods: {
        ...
        addFieldToError(field) {
            ...
            this.$set(
                this.errors,
                field,
                this.fieldInObjectIsNotEmpty(field, this.info.info_registro) ||
                    this.fieldInObjectIsNotEmpty(
                        field,
        ...
        fieldInObjectIsNotEmpty(field, object) {
            let isExistsField = this.fieldIsInObject(field, object)
            if (isExistsField) {
                let fieldIsNotUndefined =
                    this.info.info_registro[field] != undefined
                let fieldIsNotEmptyArray = this.info.info_registro[field] != []
                let fieldIsNotEmptyString = this.info.info_registro[field] != ''
                let fieldIsNotNull = this.info.info_registro[field] != null
                return (
                    fieldIsNotUndefined &&
