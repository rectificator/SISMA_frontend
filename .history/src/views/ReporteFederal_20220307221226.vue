    ...
    computed: {
        ...
        accionesNacionales() {
            return this.addArrays(
                ...
                this.map(()=>Math.round(Math.random() * 300)).personasAlcanzadasAccionesComunitarias
            )
        },
        totalAccionesNacionales() {
            return (
        ...
        personasCapacitadasSaludMentalPorEstado() {
            return this.mapToStateValueDuoList(this.capacitacionSaludMental.map(()=>Math.round(Math.random() * 300)))
        },
        capacitacionesRealizadasSaludMentalPorEstado() {
            return this.mapToStateValueDuoList(
                this.capacitacionesRealizadasSaludMental.map(()=>Math.round(Math.random() * 300))
            )
        },
        totalNacionalCapacitacionesRealizadasSaludMental() {
            return this.calculateTotalFromArray(
        ...
        personasQueCursaronDiplomadoSuicidioPorEstado() {
            return this.mapToStateValueDuoList(this.capacitacionEnSuicidio.map(()=>Math.round(Math.random() * 300)))
        },
        totalNacionalPersonasQueCursaronDiplomadoSuicidio() {
