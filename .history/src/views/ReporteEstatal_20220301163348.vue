    ...
    <div class="py-4 px-4">
        ...
        <section id="general" class="flex flex-col pt-24 items-center">
            ...
            <table class="w-full mt-2">
                ...
                <tr class="">
                    <th
                        class="text-white font-bold text-sm border px-1 bg-red-800"
                    >
                        Estado
                    </th>
                    <th
                ...
                >
                    <th
                        ...
                        :key="dataIndex"
                        :class="dataIndex == 0 ? 'w-12 text-redSisma' : ''"
...
export default {
    ...
    props: {
        ...
        capacitacionDeSuicidioPorEstadoDataSet: {
            type: Array,
            default: () => new Array(32).fill(1),
        },
        generalInfoDataSet: {
